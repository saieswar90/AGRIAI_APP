...
public class CottonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Retrofit
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://celebrate-round-question-imported.trycloudflare.com/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
    ...
    private void captureRealImage() {
        ...
        client.newCall(request).enqueue(new okhttp3.Callback() {
            ...
            public void onFailure(okhttp3.Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(CottonActivity.this,
                ...
                if (response.isSuccessful()) {
                    ...
                    try (FileOutputStream fos = new FileOutputStream(imageFile)) {
                        ...
                        runOnUiThread(() -> {
                            ...
                            Glide.with(CottonActivity.this)
                                    .load(selectedImageUri)
                                    .skipMemoryCache(true)
                                    .diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .into(imageView);
                            predictButton.setEnabled(true);
                            Toast.makeText(CottonActivity.this,
